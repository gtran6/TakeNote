...
import com.example.takenotecomposeapp.data.local.LocalTask
import com.example.takenotecomposeapp.data.network.NetworkTask
import com.example.takenotecomposeapp.data.network.TaskStatus
...
/*
JvmName is used to provide a unique name for each extension function with the same name.
